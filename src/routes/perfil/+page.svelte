...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
  ...
  >
    <div class="p-8 border-b border-slate-100 flex items-center space-x-6">
      <div
        class="w-20 h-20 rounded-2xl bg-blue-100 flex items-center justify-center text-blue-700 text-3xl font-bold border-2 border-blue-200 shadow-inner"
      >
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="col-span-1 md:col-span-2">
          ...
          <input
            ...
            class="block w-full px-4 py-3 rounded-xl border {displayErrors.name
              ? 'border-red-500'
