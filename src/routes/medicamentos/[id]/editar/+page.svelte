...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
  <div class="mb-8 flex items-center space-x-4">
    ...
    <div>
      <h1 class="text-2xl font-bold text-slate-900">Editar Medicamento</h1>
      <p class="text-slate-500">Atualize as informações do medicamento.</p>
    </div>
  </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="col-span-1 md:col-span-2">
          ...
          <input
            ...
            name="nome"
            required
            value={form?.data?.nome ?? data.medicamento.nome}
        ...
        <div class="col-span-1 md:col-span-2">
            ...
            >{form?.data?.descricao ?? data.medicamento.descricao ?? ''}</textarea>
        ...
        <div>
          ...
          <input
            ...
            id="principioAtivo"
            name="principioAtivo"
            value={form?.data?.principioAtivo ?? data.medicamento.principioAtivo ?? ''}
        ...
        <div>
          ...
          <input
            ...
            value={form?.data?.formaFarmaceutica ?? data.medicamento.formaFarmaceutica ?? ''}
        ...
        <div>
          ...
          <input
            ...
            id="concentracao"
            name="concentracao"
            value={form?.data?.concentracao ?? data.medicamento.concentracao ?? ''}
        ...
        <div>
          ...
          <input
            ...
            id="codigoBarras"
            name="codigoBarras"
            value={form?.data?.codigoBarras ?? data.medicamento.codigoBarras ?? ''}
        ...
        <div class="col-span-1 md:col-span-2">
            ...
            <input
              ...
              id="fabricante"
              name="fabricante"
              value={form?.data?.fabricante ?? data.medicamento.fabricante ?? ''}
