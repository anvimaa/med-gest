<script lang="ts">
  ...
  let { data, form = $bindable() }: { data: PageData; form: ActionData } =
    $props();
        ...
        <div>
          ...
          <input
            ...
            value={form?.data?.principioAtivo ??
              data.medicamento.principioAtivo ??
              ""}
        ...
        <div>
          ...
          <input
            ...
            value={form?.data?.formaFarmaceutica ??
              data.medicamento.formaFarmaceutica ??
              ""}
